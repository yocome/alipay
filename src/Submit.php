...
class Submit
{
     ...
     *支付宝网关地址（新）
     */
    public $gatewayNew = 'https://mapi.alipay.com/gateway.do?';
    ...
    function buildRequestForm($para_temp, $method, $button_name) {
        ...
        $sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='".$this->gatewayNew."_input_charset=".trim(strtolower($this->config['input_charset']))."' method='".$method."'>";
    ...
    function buildRequestHttp($para_temp) {
        ...
        //远程获取数据
        $sResult = Alipay::getHttpResponsePOST($this->gatewayNew, $this->config['cacert'],$request_data,trim(strtolower($this->config['input_charset'])));
    ...
    function query_timestamp() {
        $url = $this->gatewayNew."service=query_timestamp&partner=".trim(strtolower($this->config['partner']))."&_input_charset=".trim(strtolower($this->config['input_charset']));
        $encrypt_key = "";
